...
class TestArticles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Articles('Title goes here','Title is great ...','https://google.com/images','2018-05-12T13:31:03Z', 'stl', 'buzzfeed.com')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_article.author,'stl')
